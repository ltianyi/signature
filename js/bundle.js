    ...
    function($scope, $router) {
        ...
        function() {
            return setTimeout(function() {
                return window.location.href = "http://59.110.142.21:8080/zc-api/user/index?token=b77d691539306fd37badd03f7ef40b2d&productRec=0&productOrder=0"
            },
            200)
        }),
        t = function() {
            ...
            i.transform(.18, .115, -.16, .14, 850, 600),
            i.globalAlpha = .9,
            i.drawImage(r, 0, 0),
            console.log(i),
...
function(t, n, e) {
    ...
    function($scope, m0, $libsLoader) {
        ...
        t <= .5 ? n.src = "./images/iphone3.jpg": t <= 1 && (n.src = "./images/iphone3.jpg"),
        window.ipImg = n,
